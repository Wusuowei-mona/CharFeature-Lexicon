        ...
        for example in examples:
            ...
            for i, label in enumerate(example.label):
                ...
                if label != "O":
                    ...
                    # 以下是矿物数据集的
                    diff_class_labels = [l for l in ['O', 'B-GTM', 'I-GTM', 'B-GST', 'I-GST', 'B-STR', 'I-STR', 'B-ROC', 'I-ROC', 'B-MIN', 'I-MIN', 'B-PLA', 'I-PLA', 'B-ODT', 'I-ODT'] if l not in same_class_labels]
