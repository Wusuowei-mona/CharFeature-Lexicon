...
class Data():
    ...
    def convert_examples_to_features(self, examples, tokenizer, max_seq_length=256):     #这个是修改之后的
    ...
    def label_to_token_id(self,label):
        ...
        # 代码本来的：：：
        assert label in ['<B-GTM>', '<I-GTM>', '<B-GST>', '<I-GST>', '<B-STR>', '<I-STR>', '<B-ROC>', '<I-ROC>', '<B-MIN>', '<I-MIN>', '<B-PLA>', '<I-PLA>', '<B-ODT>', '<I-ODT>']
